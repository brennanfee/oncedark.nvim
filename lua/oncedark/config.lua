...
local M = { theme = "oncedark", is_setup = false }

local defaults = {
  caching = true, -- Enable caching
  cache_path = vim.fn.expand(vim.fn.stdpath("cache") .. "/oncedark"), -- The path to the cache directory
...
function M.hash()
  local hash = require("oncedark.lib.hash")(M.config)
