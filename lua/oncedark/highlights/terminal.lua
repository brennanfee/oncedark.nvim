...
function M.groups(theme)
  ...
  return {
    ...
    terminal_color_1 = theme.palette.bright_red,
    terminal_color_9 = color.brighten(theme.palette.bright_red, 15),

    terminal_color_2 = theme.palette.bright_green,
    terminal_color_10 = color.brighten(theme.palette.bright_green, 15),
    ...
    terminal_color_13 = color.brighten(theme.palette.magenta, 15),
