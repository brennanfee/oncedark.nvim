...
function M.groups(theme)
  ...
  return {
    ...
    Folded = {
      bg = config.options.transparency and "NONE" or theme.generated.fold,
      fg = theme.palette.gray,
    ...
    PmenuThumb = {
      bg = (
        theme.meta.background == "dark" and color.lighten(theme.palette.bg, 5)
        or color.darken(theme.palette.bg, 12)
      ),
