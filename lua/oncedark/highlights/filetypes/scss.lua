...
function M.groups(theme)
  ...
  return {
    ...
    ["@type.scss"] = { fg = theme.palette.bright_red },

    ["@odp.nesting_selector.scss"] = { fg = theme.palette.bright_red },
    ["@odp.pseudo_class.scss"] = { fg = theme.palette.cyan },
    ["@odp.selector.scss"] = { fg = theme.palette.orange },
    ["@odp.variable.scss"] = { fg = theme.palette.bright_red, style = config.styles.variables },
