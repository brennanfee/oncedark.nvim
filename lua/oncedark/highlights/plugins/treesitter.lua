...
function M.groups(theme)
  ...
  return {
    ...
    ["@character.special"] = { fg = theme.palette.magenta }, -- special characters (e.g. wildcards)
    ...
    ["@keyword.function"] = { fg = theme.palette.magenta, style = config.styles.functions }, -- For keywords used to define a function.
    ["@keyword.operator"] = { fg = theme.palette.magenta, style = config.styles.operators }, -- For operators that are English words, e.g. `and`, `as`, `or`.
    ...
    ["@keyword.conditional"] = { fg = theme.palette.magenta, style = config.styles.conditionals }, -- keywords related to conditionals (e.g. `if` / `else`)

    -- Punctuation
    ["@punctuation.delimiter"] = { link = "Delimiter" }, -- delimiters (e.g. `;` / `.` / `,`)
    ["@punctuation.bracket"] = { fg = theme.palette.magenta }, -- brackets (e.g. `()` / `{}` / `[]`)
