...
function M.groups(theme)
  ...
  return {
    ...
    Conditional = { fg = theme.palette.magenta, style = config.styles.conditionals }, --  if, then, else, endif, switch, etc
    Repeat = { fg = theme.palette.magenta }, -- for, do, while, etc
    Label = { fg = theme.palette.magenta }, -- case, default, etc

    Operator = { fg = theme.palette.cyan, style = config.styles.operators }, -- "sizeof", "+", "*", etc
    Keyword = { fg = theme.palette.magenta, style = config.styles.keywords }, -- any other keyword
    Exception = { link = "Keyword" }, -- try, catch, throw

    PreProc = { fg = theme.palette.yellow }, -- (preferred) generic Preprocessor
    Include = { fg = theme.palette.magenta }, -- preprocessor #include
    Define = { fg = theme.palette.magenta }, -- preprocessor #define
    ...
    Structure = { fg = theme.palette.magenta }, -- struct, union, enum, etc
    Typedef = { fg = theme.palette.magenta }, -- A typedef
